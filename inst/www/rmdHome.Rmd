...
At the bottom of each panel, there is a **Help** section. You can go through the 
...
#### Import data
- click on **Data** menu item on the sidebar and upload a **.CSV**  data 
...
- select variable names from drop-down menus
    * if selected **ID**, **nDay**  and **nBeep**  don't have multilevel 
    format, conflicting columns are cleared after an error window pops up with a 
...
- on the **Model**  panel a mixed effects formula appears under **Formula**. 
...
variable has fixed- and random-effects components.
    ...
    * under **IDs to Fit**  you can choose **All**, single or multiple IDs to 
    fit the whole data set of desired parts based of selected IDs
...
- you can remove or add a term by changing the matrix cell to zero and one respectively
